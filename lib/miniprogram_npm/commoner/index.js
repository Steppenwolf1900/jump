...
__DEFINE__(1546072717105, function(require, module, exports) {
...
}, function(modId) {var map = {"./lib/commoner":1546072717106}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1546072717106, function(require, module, exports) {
...
}, function(modId) { var map = {"./cache":1546072717107,"./watcher":1546072717109,"./context":1546072717111,"./reader":1546072717115,"./output":1546072717119,"../package.json":1546072717122}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1546072717107, function(require, module, exports) {
var assert = require("assert");
var Q = require("q");
var fs = require("fs");
var path = require("path");
...
__DEFINE__(1546072717109, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
...
}, function(modId) { var map = {"./cache":1546072717107}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1546072717111, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var Q = require("q");
var util = require("./util");
...
}, function(modId) { var map = {"./cache":1546072717107,"./grep":1546072717113}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1546072717113, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var Q = require("q");
var fs = require("graceful-fs");
...
__DEFINE__(1546072717115, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var fs = require("fs");
var Q = require("q");
...
}, function(modId) { var map = {"./context":1546072717111,"./relative":1546072717117}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1546072717117, function(require, module, exports) {
var assert = require("assert");
var Q = require("q");
var path = require("path");
var util = require("./util");
...
}, function(modId) { var map = {"./reader":1546072717115}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1546072717119, function(require, module, exports) {
var assert = require("assert");
var util = require("./util");
var log = util.log;
...
__DEFINE__(1546072717122, function(require, module, exports) {
module.exports = {
  ...
  "_resolved": "http://registry.npm.taobao.org/commoner/download/commoner-0.10.8.tgz",
...
return __REQUIRE__(1546072717105);
})()
